...
export type FirmwareTableRowFragment = { __typename?: 'AndroidFirmwareType', id: string, absoluteStorePath: string, aecsBuildFilePath?: string | null, fileSizeBytes?: number | null, filename: string, hasFileIndex?: boolean | null, hasFuzzyHashIndex?: boolean | null, indexedDate?: any | null, md5: string, originalFilename: string, osVendor: string, partitionInfoDict?: any | null, relativeStorePath: string, sha1: string, sha256: string, tag?: string | null, versionDetected?: number | null, pk?: string | null } & { ' $fragmentName'?: 'FirmwareTableRowFragment' };
