...
export type ApkidReportFragment = { __typename?: 'ApkidReportType', id?: string | null, results: any, reportDate: any, scannerName: string, scannerVersion: string } & { ' $fragmentName'?: 'ApkidReportFragment' };
